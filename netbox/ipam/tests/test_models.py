...
class TestVLANGroup(TestCase):
    ...
    def test_get_next_available_vid(self):
        ...
        VLAN.objects.bulk_create((
            VLAN(name='VLAN 1', vid=1, group=vlangroup, tenant=tenant),
            VLAN(name='VLAN 2', vid=2, group=vlangroup, tenant=tenant),
            VLAN(name='VLAN 3', vid=3, group=vlangroup, tenant=tenant),
            VLAN(name='VLAN 5', vid=5, group=vlangroup, tenant=tenant),
        ))
        self.assertEqual(vlangroup.get_next_available_vid(), 4)

        VLAN.objects.bulk_create((
            VLAN(name='VLAN 4', vid=4, group=vlangroup, tenant=tenant),
        ))
