...
class OverlayNetworkGroupCreateView(ObjectEditView):
...
class OverlayNetworkGroupBulkImportView(BulkImportView):
    permission_required = 'ipam.add_overlaynetworkgroup'
...
class OverlayNetworkGroupBulkDeleteView(BulkDeleteView):
...
class OverlayNetworkCreateView(ObjectEditView):
...
class OverlayNetworkDeleteView(ObjectDeleteView):
    model = OverlayNetwork
    default_return_url = 'ipam:overlay_network_list'


class OverlayNetworkBulkImportView(BulkImportView):
    model_form = forms.OverlayNetworkCSVForm
    table = tables.OverlayNetworkTable
    default_return_url = 'ipam:overlay_network_list'


class OverlayNetworkBulkEditView(BulkEditView):
    queryset = OverlayNetwork.objects.select_related('site', 'group', 'tenant', 'role')
...
class OverlayNetworkBulkDeleteView(BulkDeleteView):
    queryset = OverlayNetwork.objects.select_related('site', 'group', 'tenant', 'role')
    filter = filters.OverlayNetworkFilterSet
    table = tables.OverlayNetworkTable
    default_return_url = 'ipam:overlay_network_list'
