...
from . import views
from .models import (
    Aggregate, IPAddress, Prefix, RIR, Role, RouteTarget, Service, OverlayNetwork, VLAN,
...
urlpatterns = [
    ...
    path('overlay-network-groups/', views.OverlayNetworkGroupListView.as_view(), name='overlay_networkgroup_list'),
    path('overlay-network-groups/add/', views.OverlayNetworkGroupCreateView.as_view(), name='overlay_networkgroup_add'),
    path('overlay-network-groups/import/', views.OverlayNetworkGroupBulkImportView.as_view(), name='overlay_networkgroup_import'),
    path('overlay-network-groups/delete/', views.OverlayNetworkGroupBulkDeleteView.as_view(), name='overlay_networkgroup_bulk_delete'),
    path('overlay-network-groups/<int:pk>/edit/', views.OverlayNetworkGroupEditView.as_view(), name='overlay_networkgroup_edit'),
    path('overlay-network-groups/<int:pk>/overlay_networks/', views.OverlayNetworkGroupOverlayNetworksView.as_view(), name='overlay_networkgroup_overlay_networks'),
    path('overlay-network-groups/<int:pk>/changelog/', ObjectChangeLogView.as_view(), name='overlay_networkgroup_changelog', kwargs={'model': OverlayNetworkGroup}),
    ...
    # Overlay Networks
    path('overlay_networks/', views.OverlayNetworkListView.as_view(), name='overlay_network_list'),
    path('overlay_networks/add/', views.OverlayNetworkCreateView.as_view(), name='overlay_network_add'),
    path('overlay_networks/import/', views.OverlayNetworkBulkImportView.as_view(), name='overlay_network_import'),
    path('overlay_networks/edit/', views.OverlayNetworkBulkEditView.as_view(), name='overlay_network_bulk_edit'),
    path('overlay_networks/delete/', views.OverlayNetworkBulkDeleteView.as_view(), name='overlay_network_bulk_delete'),
    path('overlay_networks/<int:pk>/', views.OverlayNetworkView.as_view(), name='overlay_network'),
    path('overlay_networks/<int:pk>/members/', views.OverlayNetworkMembersView.as_view(), name='overlay_network_members'),
    path('overlay_networks/<int:pk>/edit/', views.OverlayNetworkEditView.as_view(), name='overlay_network_edit'),
    path('overlay_networks/<int:pk>/delete/', views.OverlayNetworkDeleteView.as_view(), name='overlay_network_delete'),
    path('overlay_networks/<int:pk>/changelog/', ObjectChangeLogView.as_view(), name='overlay_network_changelog', kwargs={'model': OverlayNetwork}),
