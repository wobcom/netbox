...
class InterfaceTestCase(
    ...
    def setUpTestData(cls):
        ...
        vlans = (
            VLAN(vid=1, name='VLAN1', site=device.site, tenant=tenant),
            VLAN(vid=101, name='VLAN101', site=device.site, tenant=tenant),
            VLAN(vid=102, name='VLAN102', site=device.site, tenant=tenant),
            VLAN(vid=103, name='VLAN103', site=device.site, tenant=tenant),
        )
